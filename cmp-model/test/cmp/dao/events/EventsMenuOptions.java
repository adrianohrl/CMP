...
public enum EventsMenuOptions {
    ...
    SHOW_ALL_ENTRY_EVENTS(10, "show all registered entry events"),
    SHOW_ALL_TIME_CLOCK_EVENTS(11, "show all registered time clock events"),
    SHOW_ALL_EVENTS(12, "show all registered employee events"),
    IMPORT_ENTRY_EVENTS(13, "import entry events"),
    IMPORT_TIME_CLOCK_EVENTS(14, "import time clock events"),
    REPORT_PER_SUBORDINATE(15, "report subordinate performance"),
    REPORT_PER_SUBORDINATES(16, "report subordinates performance"),
    REPORT_PER_SUPERVISOR(17, "report all supervisor subordinates performance"),
    REPORT_PER_SUPERVISORS(18, "report all supervisors subordinates performance"),
    REPORT_PER_SECTOR(19, "report all sector subordinates performance"),
    REPORT_PER_SECTORS(20, "report all sectors subordinates performance"),
    QUIT(-1, "quit");
