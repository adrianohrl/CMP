...
public enum EventsMenuOptions {
    ...
    SHOW_PERIOD_ENTRY_EVENTS(13, "show registered period entry events"),
    SHOW_ALL_TIME_CLOCK_EVENTS(14, "show all registered time clock events"),
    SHOW_PERIOD_TIME_CLOCK_EVENTS(15, "show registered period time clock events"),
    SHOW_ALL_EVENTS(16, "show all registered employee events"),
    SHOW_PERIOD_EVENTS(17, "show registered period employee events"),
    IMPORT_ENTRY_EVENTS(18, "import entry events"),
    IMPORT_TIME_CLOCK_EVENTS(19, "import time clock events"),
    REPORT_PER_SUBORDINATE(20, "report subordinate performance"),
    REPORT_PER_SUBORDINATES(21, "report subordinates performance"),
    REPORT_PER_SUPERVISOR(22, "report all supervisor subordinates performance"),
    REPORT_PER_SUPERVISORS(23, "report all supervisors subordinates performance"),
    REPORT_PER_SECTOR(24, "report all sector subordinates performance"),
    REPORT_PER_SECTORS(25, "report all sectors subordinates performance"),
    QUIT(-1, "quit");
