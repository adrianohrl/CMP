...
public class ModelOrderTest {
    ...
    private static void createModels() {
        ...
        model.getParts().add(new ModelPart("Frente", "Frente 123 qdsdawr31", "This is a horizontally too big observation!!! The intention here is to see if the text fits in the text area properly. Let's see if it works. I have no idea of the final result. Aaaahhh, I should also see what happens if the input obsevation text it also vertically too big. What shoud i do?? I have no idea.", fabrics.get("LIBERT")));
        model.getParts().add(new ModelPart("Mangas", "Manga 123 qdsdawr31", "", fabrics.get("RENDA")));
