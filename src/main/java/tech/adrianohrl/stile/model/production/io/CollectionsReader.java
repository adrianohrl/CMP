 ...
 */
public class CollectionsReader extends AbstractReader<Collection> {
    
    /** Column Titles **/
    private final static String NAME_COLUMN_TITLE = PropertyUtil.getCollectionColumnTitle("Name");
